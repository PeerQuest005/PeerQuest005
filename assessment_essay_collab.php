...
<head>
    <meta charset="UTF-8">
    <title>Edit Collab | PeerQuest</title>
...
<div class="sidebar">
    <div class="logo-container">
        ...
        <div class="content">
        <div class="top-bar">
        <h1 class="dashboard-title"> Edit Assessment - ESSAY COLLABORATIVE</h1>
        </div>
...
<div class="card">
    ...
    <script>
        ...
        if (confirm("Are you sure you want to remove this question?")) {
            ...
            try {
            const response = await fetch('assessment_essay_collab.php?assessment_id=<?php echo $assessment_id; ?>', {
                method: 'POST',
                body: formData
            });
...
async function updateField(url, data) {
    ...
    if (shouldScroll) {
        ...
        // Remove scroll from URL after execution
